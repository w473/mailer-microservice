...
const { Template, TemplateLocale } = require('../../src/models/templateModel');
const fs = require('fs').promises;
const httpMocks = require('node-mocks-http');
const { assert } = require('chai');

const mailsController = require('../../src/controllers/mailsController');
...
describe('Mails', () => {
  ...
  it('get', async () => {
    ...
    assert.equal(
      json.data.recepient.userId,
      '91d4fd43-998a-4614-ae91-5d4971522fec'
    );
  ...
  it('getAll', async () => {
    ...
    assert.equal(
      json.data[1].recepient.userId,
      'b73140f0-d3c2-4b9d-9e21-f45130dd221a'
    );
