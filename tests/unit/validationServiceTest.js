const validate = require('../../src/services/validationService');
    ...
    templateLocales: [
      {
        ...
        subject: 'asdas',
        contents:
          'asdasasdas asdasasdas asdasasdas asdasasdas asdasasdas asdasasdas'
      }
    ]
  };
...
it('validate templateLocale Error', function () {
  ...
  const tests = [
    {
      body: {},
      errors: ["should have required property 'name'"],
      count: 1
    },
    {
      body: {
...
it('validate mail Error', function () {
  const tests = [
    ...
    },
    {
      ...
      errors: ['should match format "uuid"'],
      count: 1
    }
  ];
